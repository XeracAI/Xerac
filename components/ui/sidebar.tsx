...
>(
  (
    { defaultOpen = true, open: openProp, onOpenChange: setOpenProp, initialBalance, className, style, children, ...props },
    ref,
  ) => {
    ...
    const contextValue = React.useMemo<SidebarContext>(
      ...
      [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, balance, setBalance, updateBalance],
    );
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      {showIcon && <Skeleton className="size-4 rounded-md bg-sidebar-accent-foreground/10" data-sidebar="menu-skeleton-icon" />}
      <Skeleton
